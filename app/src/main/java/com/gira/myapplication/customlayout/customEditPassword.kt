package com.gira.myapplication.customlayout
...
class CustomEditPassword:AppCompatEditText, View.OnTouchListener {
    ...
    override fun onDraw(canvas: Canvas?) {
        super.onDraw(canvas)
        showPassword()
        setBackgroundResource(R.drawable.custom_layout_box)
    ...
    private fun init(){
        hiddenPassword = ContextCompat.getDrawable(context,R.drawable.hide_password_icon) as Drawable
        hintColor = ContextCompat.getColor(context,R.color.gray)
        textChangeListener()
                ...
                return when (event.action) {
                    MotionEvent.ACTION_DOWN -> {
                        ...
                        if (transformationMethod.equals(HideReturnsTransformationMethod.getInstance())) {
                            ...
                            hiddenPassword = ContextCompat.getDrawable(context, R.drawable.show_password_icon) as Drawable
                            showPassword()
                        }
                        true
                    }
